...
/*
#cgo windows LDFLAGS: -L${SRCDIR}/lib/v6.7.11_20250617_api_traderapi_se_win64 -lthostmduserapi_se -lthosttraderapi_se -lstdc++
#cgo windows CXXFLAGS: -std=c++11
#cgo windows CPPFLAGS: -I${SRCDIR}/lib/v6.7.11_20250617_api_traderapi_se_win64/
*/
import "C"
import (
