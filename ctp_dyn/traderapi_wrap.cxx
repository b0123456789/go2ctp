...
// SPBM期货合约参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQrySPBMFutureParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQrySPBMFutureParameterField* pQrySPBMFutureParameter, int nRequestID)
{
    return pTraderApi->ReqQrySPBMFutureParameter(pQrySPBMFutureParameter, nRequestID);
}

// SPBM期权合约参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQrySPBMOptionParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQrySPBMOptionParameterField* pQrySPBMOptionParameter, int nRequestID)
{
    return pTraderApi->ReqQrySPBMOptionParameter(pQrySPBMOptionParameter, nRequestID);
}

// SPBM品种内对锁仓折扣参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQrySPBMIntraParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQrySPBMIntraParameterField* pQrySPBMIntraParameter, int nRequestID)
{
    return pTraderApi->ReqQrySPBMIntraParameter(pQrySPBMIntraParameter, nRequestID);
}

// SPBM跨品种抵扣参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQrySPBMInterParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQrySPBMInterParameterField* pQrySPBMInterParameter, int nRequestID)
{
    return pTraderApi->ReqQrySPBMInterParameter(pQrySPBMInterParameter, nRequestID);
}

// SPBM组合保证金套餐查询
int _wrap_tts_CThostFtdcTraderApi_ReqQrySPBMPortfDefinition(TTSCTPTraderSpi* pTraderApi, CThostFtdcQrySPBMPortfDefinitionField* pQrySPBMPortfDefinition, int nRequestID)
{
    return pTraderApi->ReqQrySPBMPortfDefinition(pQrySPBMPortfDefinition, nRequestID);
}

// 投资者SPBM套餐选择查询
int _wrap_tts_CThostFtdcTraderApi_ReqQrySPBMInvestorPortfDef(TTSCTPTraderSpi* pTraderApi, CThostFtdcQrySPBMInvestorPortfDefField* pQrySPBMInvestorPortfDef, int nRequestID)
{
    return pTraderApi->ReqQrySPBMInvestorPortfDef(pQrySPBMInvestorPortfDef, nRequestID);
}

// 投资者新型组合保证金系数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryInvestorPortfMarginRatio(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryInvestorPortfMarginRatioField* pQryInvestorPortfMarginRatio, int nRequestID)
{
    return pTraderApi->ReqQryInvestorPortfMarginRatio(pQryInvestorPortfMarginRatio, nRequestID);
}

// 投资者产品SPBM明细查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryInvestorProdSPBMDetail(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryInvestorProdSPBMDetailField* pQryInvestorProdSPBMDetail, int nRequestID)
{
    return pTraderApi->ReqQryInvestorProdSPBMDetail(pQryInvestorProdSPBMDetail, nRequestID);
}

// 投资者商品组SPMM记录查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryInvestorCommoditySPMMMargin(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryInvestorCommoditySPMMMarginField* pQryInvestorCommoditySPMMMargin, int nRequestID)
{
    return pTraderApi->ReqQryInvestorCommoditySPMMMargin(pQryInvestorCommoditySPMMMargin, nRequestID);
}

// 投资者商品群SPMM记录查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryInvestorCommodityGroupSPMMMargin(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryInvestorCommodityGroupSPMMMarginField* pQryInvestorCommodityGroupSPMMMargin, int nRequestID)
{
    return pTraderApi->ReqQryInvestorCommodityGroupSPMMMargin(pQryInvestorCommodityGroupSPMMMargin, nRequestID);
}

// SPMM合约参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQrySPMMInstParam(TTSCTPTraderSpi* pTraderApi, CThostFtdcQrySPMMInstParamField* pQrySPMMInstParam, int nRequestID)
{
    return pTraderApi->ReqQrySPMMInstParam(pQrySPMMInstParam, nRequestID);
}

// SPMM产品参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQrySPMMProductParam(TTSCTPTraderSpi* pTraderApi, CThostFtdcQrySPMMProductParamField* pQrySPMMProductParam, int nRequestID)
{
    return pTraderApi->ReqQrySPMMProductParam(pQrySPMMProductParam, nRequestID);
}

// SPBM附加跨品种抵扣参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQrySPBMAddOnInterParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQrySPBMAddOnInterParameterField* pQrySPBMAddOnInterParameter, int nRequestID)
{
    return pTraderApi->ReqQrySPBMAddOnInterParameter(pQrySPBMAddOnInterParameter, nRequestID);
}

// RCAMS产品组合信息查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryRCAMSCombProductInfo(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryRCAMSCombProductInfoField* pQryRCAMSCombProductInfo, int nRequestID)
{
    return pTraderApi->ReqQryRCAMSCombProductInfo(pQryRCAMSCombProductInfo, nRequestID);
}

// RCAMS同合约风险对冲参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryRCAMSInstrParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryRCAMSInstrParameterField* pQryRCAMSInstrParameter, int nRequestID)
{
    return pTraderApi->ReqQryRCAMSInstrParameter(pQryRCAMSInstrParameter, nRequestID);
}

// RCAMS品种内风险对冲参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryRCAMSIntraParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryRCAMSIntraParameterField* pQryRCAMSIntraParameter, int nRequestID)
{
    return pTraderApi->ReqQryRCAMSIntraParameter(pQryRCAMSIntraParameter, nRequestID);
}

// RCAMS跨品种风险折抵参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryRCAMSInterParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryRCAMSInterParameterField* pQryRCAMSInterParameter, int nRequestID)
{
    return pTraderApi->ReqQryRCAMSInterParameter(pQryRCAMSInterParameter, nRequestID);
}

// RCAMS空头期权风险调整参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryRCAMSShortOptAdjustParam(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryRCAMSShortOptAdjustParamField* pQryRCAMSShortOptAdjustParam, int nRequestID)
{
    return pTraderApi->ReqQryRCAMSShortOptAdjustParam(pQryRCAMSShortOptAdjustParam, nRequestID);
}

// RCAMS策略组合持仓查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryRCAMSInvestorCombPosition(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryRCAMSInvestorCombPositionField* pQryRCAMSInvestorCombPosition, int nRequestID)
{
    return pTraderApi->ReqQryRCAMSInvestorCombPosition(pQryRCAMSInvestorCombPosition, nRequestID);
}

// 投资者品种RCAMS保证金查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryInvestorProdRCAMSMargin(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryInvestorProdRCAMSMarginField* pQryInvestorProdRCAMSMargin, int nRequestID)
{
    return pTraderApi->ReqQryInvestorProdRCAMSMargin(pQryInvestorProdRCAMSMargin, nRequestID);
}

// RULE合约保证金参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryRULEInstrParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryRULEInstrParameterField* pQryRULEInstrParameter, int nRequestID)
{
    return pTraderApi->ReqQryRULEInstrParameter(pQryRULEInstrParameter, nRequestID);
}

// RULE品种内对锁仓折扣参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryRULEIntraParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryRULEIntraParameterField* pQryRULEIntraParameter, int nRequestID)
{
    return pTraderApi->ReqQryRULEIntraParameter(pQryRULEIntraParameter, nRequestID);
}

// RULE跨品种抵扣参数查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryRULEInterParameter(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryRULEInterParameterField* pQryRULEInterParameter, int nRequestID)
{
    return pTraderApi->ReqQryRULEInterParameter(pQryRULEInterParameter, nRequestID);
}

// 投资者产品RULE保证金查询
int _wrap_tts_CThostFtdcTraderApi_ReqQryInvestorProdRULEMargin(TTSCTPTraderSpi* pTraderApi, CThostFtdcQryInvestorProdRULEMarginField* pQryInvestorProdRULEMargin, int nRequestID)
{
...
// SPBM期货合约参数查询响应
extern "C" void wrap_tts_TraderOnRspQrySPBMFutureParameter(uintptr_t, CThostFtdcSPBMFutureParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQrySPBMFutureParameter(CThostFtdcSPBMFutureParameterField* pSPBMFutureParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQrySPBMFutureParameter(gUserApi, pSPBMFutureParameter, pRspInfo, nRequestID, bIsLast);
}

// SPBM期权合约参数查询响应
extern "C" void wrap_tts_TraderOnRspQrySPBMOptionParameter(uintptr_t, CThostFtdcSPBMOptionParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQrySPBMOptionParameter(CThostFtdcSPBMOptionParameterField* pSPBMOptionParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQrySPBMOptionParameter(gUserApi, pSPBMOptionParameter, pRspInfo, nRequestID, bIsLast);
}

// SPBM品种内对锁仓折扣参数查询响应
extern "C" void wrap_tts_TraderOnRspQrySPBMIntraParameter(uintptr_t, CThostFtdcSPBMIntraParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQrySPBMIntraParameter(CThostFtdcSPBMIntraParameterField* pSPBMIntraParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQrySPBMIntraParameter(gUserApi, pSPBMIntraParameter, pRspInfo, nRequestID, bIsLast);
}

// SPBM跨品种抵扣参数查询响应
extern "C" void wrap_tts_TraderOnRspQrySPBMInterParameter(uintptr_t, CThostFtdcSPBMInterParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQrySPBMInterParameter(CThostFtdcSPBMInterParameterField* pSPBMInterParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQrySPBMInterParameter(gUserApi, pSPBMInterParameter, pRspInfo, nRequestID, bIsLast);
}

// SPBM组合保证金套餐查询响应
extern "C" void wrap_tts_TraderOnRspQrySPBMPortfDefinition(uintptr_t, CThostFtdcSPBMPortfDefinitionField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQrySPBMPortfDefinition(CThostFtdcSPBMPortfDefinitionField* pSPBMPortfDefinition, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQrySPBMPortfDefinition(gUserApi, pSPBMPortfDefinition, pRspInfo, nRequestID, bIsLast);
}

// 投资者SPBM套餐选择查询响应
extern "C" void wrap_tts_TraderOnRspQrySPBMInvestorPortfDef(uintptr_t, CThostFtdcSPBMInvestorPortfDefField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQrySPBMInvestorPortfDef(CThostFtdcSPBMInvestorPortfDefField* pSPBMInvestorPortfDef, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQrySPBMInvestorPortfDef(gUserApi, pSPBMInvestorPortfDef, pRspInfo, nRequestID, bIsLast);
}

// 投资者新型组合保证金系数查询响应
extern "C" void wrap_tts_TraderOnRspQryInvestorPortfMarginRatio(uintptr_t, CThostFtdcInvestorPortfMarginRatioField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryInvestorPortfMarginRatio(CThostFtdcInvestorPortfMarginRatioField* pInvestorPortfMarginRatio, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryInvestorPortfMarginRatio(gUserApi, pInvestorPortfMarginRatio, pRspInfo, nRequestID, bIsLast);
}

// 投资者产品SPBM明细查询响应
extern "C" void wrap_tts_TraderOnRspQryInvestorProdSPBMDetail(uintptr_t, CThostFtdcInvestorProdSPBMDetailField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryInvestorProdSPBMDetail(CThostFtdcInvestorProdSPBMDetailField* pInvestorProdSPBMDetail, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryInvestorProdSPBMDetail(gUserApi, pInvestorProdSPBMDetail, pRspInfo, nRequestID, bIsLast);
}

// 投资者商品组SPMM记录查询响应
extern "C" void wrap_tts_TraderOnRspQryInvestorCommoditySPMMMargin(uintptr_t, CThostFtdcInvestorCommoditySPMMMarginField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryInvestorCommoditySPMMMargin(CThostFtdcInvestorCommoditySPMMMarginField* pInvestorCommoditySPMMMargin, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryInvestorCommoditySPMMMargin(gUserApi, pInvestorCommoditySPMMMargin, pRspInfo, nRequestID, bIsLast);
}

// 投资者商品群SPMM记录查询响应
extern "C" void wrap_tts_TraderOnRspQryInvestorCommodityGroupSPMMMargin(uintptr_t, CThostFtdcInvestorCommodityGroupSPMMMarginField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryInvestorCommodityGroupSPMMMargin(CThostFtdcInvestorCommodityGroupSPMMMarginField* pInvestorCommodityGroupSPMMMargin, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryInvestorCommodityGroupSPMMMargin(gUserApi, pInvestorCommodityGroupSPMMMargin, pRspInfo, nRequestID, bIsLast);
}

// SPMM合约参数查询响应
extern "C" void wrap_tts_TraderOnRspQrySPMMInstParam(uintptr_t, CThostFtdcSPMMInstParamField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQrySPMMInstParam(CThostFtdcSPMMInstParamField* pSPMMInstParam, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQrySPMMInstParam(gUserApi, pSPMMInstParam, pRspInfo, nRequestID, bIsLast);
}

// SPMM产品参数查询响应
extern "C" void wrap_tts_TraderOnRspQrySPMMProductParam(uintptr_t, CThostFtdcSPMMProductParamField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQrySPMMProductParam(CThostFtdcSPMMProductParamField* pSPMMProductParam, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQrySPMMProductParam(gUserApi, pSPMMProductParam, pRspInfo, nRequestID, bIsLast);
}

// SPBM附加跨品种抵扣参数查询响应
extern "C" void wrap_tts_TraderOnRspQrySPBMAddOnInterParameter(uintptr_t, CThostFtdcSPBMAddOnInterParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQrySPBMAddOnInterParameter(CThostFtdcSPBMAddOnInterParameterField* pSPBMAddOnInterParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQrySPBMAddOnInterParameter(gUserApi, pSPBMAddOnInterParameter, pRspInfo, nRequestID, bIsLast);
}

// RCAMS产品组合信息查询响应
extern "C" void wrap_tts_TraderOnRspQryRCAMSCombProductInfo(uintptr_t, CThostFtdcRCAMSCombProductInfoField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryRCAMSCombProductInfo(CThostFtdcRCAMSCombProductInfoField* pRCAMSCombProductInfo, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryRCAMSCombProductInfo(gUserApi, pRCAMSCombProductInfo, pRspInfo, nRequestID, bIsLast);
}

// RCAMS同合约风险对冲参数查询响应
extern "C" void wrap_tts_TraderOnRspQryRCAMSInstrParameter(uintptr_t, CThostFtdcRCAMSInstrParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryRCAMSInstrParameter(CThostFtdcRCAMSInstrParameterField* pRCAMSInstrParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryRCAMSInstrParameter(gUserApi, pRCAMSInstrParameter, pRspInfo, nRequestID, bIsLast);
}

// RCAMS品种内风险对冲参数查询响应
extern "C" void wrap_tts_TraderOnRspQryRCAMSIntraParameter(uintptr_t, CThostFtdcRCAMSIntraParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryRCAMSIntraParameter(CThostFtdcRCAMSIntraParameterField* pRCAMSIntraParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryRCAMSIntraParameter(gUserApi, pRCAMSIntraParameter, pRspInfo, nRequestID, bIsLast);
}

// RCAMS跨品种风险折抵参数查询响应
extern "C" void wrap_tts_TraderOnRspQryRCAMSInterParameter(uintptr_t, CThostFtdcRCAMSInterParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryRCAMSInterParameter(CThostFtdcRCAMSInterParameterField* pRCAMSInterParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryRCAMSInterParameter(gUserApi, pRCAMSInterParameter, pRspInfo, nRequestID, bIsLast);
}

// RCAMS空头期权风险调整参数查询响应
extern "C" void wrap_tts_TraderOnRspQryRCAMSShortOptAdjustParam(uintptr_t, CThostFtdcRCAMSShortOptAdjustParamField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryRCAMSShortOptAdjustParam(CThostFtdcRCAMSShortOptAdjustParamField* pRCAMSShortOptAdjustParam, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryRCAMSShortOptAdjustParam(gUserApi, pRCAMSShortOptAdjustParam, pRspInfo, nRequestID, bIsLast);
}

// RCAMS策略组合持仓查询响应
extern "C" void wrap_tts_TraderOnRspQryRCAMSInvestorCombPosition(uintptr_t, CThostFtdcRCAMSInvestorCombPositionField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryRCAMSInvestorCombPosition(CThostFtdcRCAMSInvestorCombPositionField* pRCAMSInvestorCombPosition, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryRCAMSInvestorCombPosition(gUserApi, pRCAMSInvestorCombPosition, pRspInfo, nRequestID, bIsLast);
}

// 投资者品种RCAMS保证金查询响应
extern "C" void wrap_tts_TraderOnRspQryInvestorProdRCAMSMargin(uintptr_t, CThostFtdcInvestorProdRCAMSMarginField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryInvestorProdRCAMSMargin(CThostFtdcInvestorProdRCAMSMarginField* pInvestorProdRCAMSMargin, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryInvestorProdRCAMSMargin(gUserApi, pInvestorProdRCAMSMargin, pRspInfo, nRequestID, bIsLast);
}

// RULE合约保证金参数查询响应
extern "C" void wrap_tts_TraderOnRspQryRULEInstrParameter(uintptr_t, CThostFtdcRULEInstrParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryRULEInstrParameter(CThostFtdcRULEInstrParameterField* pRULEInstrParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryRULEInstrParameter(gUserApi, pRULEInstrParameter, pRspInfo, nRequestID, bIsLast);
}

// RULE品种内对锁仓折扣参数查询响应
extern "C" void wrap_tts_TraderOnRspQryRULEIntraParameter(uintptr_t, CThostFtdcRULEIntraParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryRULEIntraParameter(CThostFtdcRULEIntraParameterField* pRULEIntraParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryRULEIntraParameter(gUserApi, pRULEIntraParameter, pRspInfo, nRequestID, bIsLast);
}

// RULE跨品种抵扣参数查询响应
extern "C" void wrap_tts_TraderOnRspQryRULEInterParameter(uintptr_t, CThostFtdcRULEInterParameterField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryRULEInterParameter(CThostFtdcRULEInterParameterField* pRULEInterParameter, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    wrap_tts_TraderOnRspQryRULEInterParameter(gUserApi, pRULEInterParameter, pRspInfo, nRequestID, bIsLast);
}

// 投资者产品RULE保证金查询响应
extern "C" void wrap_tts_TraderOnRspQryInvestorProdRULEMargin(uintptr_t, CThostFtdcInvestorProdRULEMarginField*, CThostFtdcRspInfoField*, int, bool);
void TTSCTPTraderSpi::OnRspQryInvestorProdRULEMargin(CThostFtdcInvestorProdRULEMarginField* pInvestorProdRULEMargin, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
...
// SPBM期货合约参数查询
int TTSCTPTraderSpi::ReqQrySPBMFutureParameter(CThostFtdcQrySPBMFutureParameterField* pQrySPBMFutureParameter, int nRequestID)
{
    return this->pUserApi->ReqQrySPBMFutureParameter(pQrySPBMFutureParameter, nRequestID);
}

// SPBM期权合约参数查询
int TTSCTPTraderSpi::ReqQrySPBMOptionParameter(CThostFtdcQrySPBMOptionParameterField* pQrySPBMOptionParameter, int nRequestID)
{
    return this->pUserApi->ReqQrySPBMOptionParameter(pQrySPBMOptionParameter, nRequestID);
}

// SPBM品种内对锁仓折扣参数查询
int TTSCTPTraderSpi::ReqQrySPBMIntraParameter(CThostFtdcQrySPBMIntraParameterField* pQrySPBMIntraParameter, int nRequestID)
{
    return this->pUserApi->ReqQrySPBMIntraParameter(pQrySPBMIntraParameter, nRequestID);
}

// SPBM跨品种抵扣参数查询
int TTSCTPTraderSpi::ReqQrySPBMInterParameter(CThostFtdcQrySPBMInterParameterField* pQrySPBMInterParameter, int nRequestID)
{
    return this->pUserApi->ReqQrySPBMInterParameter(pQrySPBMInterParameter, nRequestID);
}

// SPBM组合保证金套餐查询
int TTSCTPTraderSpi::ReqQrySPBMPortfDefinition(CThostFtdcQrySPBMPortfDefinitionField* pQrySPBMPortfDefinition, int nRequestID)
{
    return this->pUserApi->ReqQrySPBMPortfDefinition(pQrySPBMPortfDefinition, nRequestID);
}

// 投资者SPBM套餐选择查询
int TTSCTPTraderSpi::ReqQrySPBMInvestorPortfDef(CThostFtdcQrySPBMInvestorPortfDefField* pQrySPBMInvestorPortfDef, int nRequestID)
{
    return this->pUserApi->ReqQrySPBMInvestorPortfDef(pQrySPBMInvestorPortfDef, nRequestID);
}

// 投资者新型组合保证金系数查询
int TTSCTPTraderSpi::ReqQryInvestorPortfMarginRatio(CThostFtdcQryInvestorPortfMarginRatioField* pQryInvestorPortfMarginRatio, int nRequestID)
{
    return this->pUserApi->ReqQryInvestorPortfMarginRatio(pQryInvestorPortfMarginRatio, nRequestID);
}

// 投资者产品SPBM明细查询
int TTSCTPTraderSpi::ReqQryInvestorProdSPBMDetail(CThostFtdcQryInvestorProdSPBMDetailField* pQryInvestorProdSPBMDetail, int nRequestID)
{
    return this->pUserApi->ReqQryInvestorProdSPBMDetail(pQryInvestorProdSPBMDetail, nRequestID);
}

// 投资者商品组SPMM记录查询
int TTSCTPTraderSpi::ReqQryInvestorCommoditySPMMMargin(CThostFtdcQryInvestorCommoditySPMMMarginField* pQryInvestorCommoditySPMMMargin, int nRequestID)
{
    return this->pUserApi->ReqQryInvestorCommoditySPMMMargin(pQryInvestorCommoditySPMMMargin, nRequestID);
}

// 投资者商品群SPMM记录查询
int TTSCTPTraderSpi::ReqQryInvestorCommodityGroupSPMMMargin(CThostFtdcQryInvestorCommodityGroupSPMMMarginField* pQryInvestorCommodityGroupSPMMMargin, int nRequestID)
{
    return this->pUserApi->ReqQryInvestorCommodityGroupSPMMMargin(pQryInvestorCommodityGroupSPMMMargin, nRequestID);
}

// SPMM合约参数查询
int TTSCTPTraderSpi::ReqQrySPMMInstParam(CThostFtdcQrySPMMInstParamField* pQrySPMMInstParam, int nRequestID)
{
    return this->pUserApi->ReqQrySPMMInstParam(pQrySPMMInstParam, nRequestID);
}

// SPMM产品参数查询
int TTSCTPTraderSpi::ReqQrySPMMProductParam(CThostFtdcQrySPMMProductParamField* pQrySPMMProductParam, int nRequestID)
{
    return this->pUserApi->ReqQrySPMMProductParam(pQrySPMMProductParam, nRequestID);
}

// SPBM附加跨品种抵扣参数查询
int TTSCTPTraderSpi::ReqQrySPBMAddOnInterParameter(CThostFtdcQrySPBMAddOnInterParameterField* pQrySPBMAddOnInterParameter, int nRequestID)
{
    return this->pUserApi->ReqQrySPBMAddOnInterParameter(pQrySPBMAddOnInterParameter, nRequestID);
}

// RCAMS产品组合信息查询
int TTSCTPTraderSpi::ReqQryRCAMSCombProductInfo(CThostFtdcQryRCAMSCombProductInfoField* pQryRCAMSCombProductInfo, int nRequestID)
{
    return this->pUserApi->ReqQryRCAMSCombProductInfo(pQryRCAMSCombProductInfo, nRequestID);
}

// RCAMS同合约风险对冲参数查询
int TTSCTPTraderSpi::ReqQryRCAMSInstrParameter(CThostFtdcQryRCAMSInstrParameterField* pQryRCAMSInstrParameter, int nRequestID)
{
    return this->pUserApi->ReqQryRCAMSInstrParameter(pQryRCAMSInstrParameter, nRequestID);
}

// RCAMS品种内风险对冲参数查询
int TTSCTPTraderSpi::ReqQryRCAMSIntraParameter(CThostFtdcQryRCAMSIntraParameterField* pQryRCAMSIntraParameter, int nRequestID)
{
    return this->pUserApi->ReqQryRCAMSIntraParameter(pQryRCAMSIntraParameter, nRequestID);
}

// RCAMS跨品种风险折抵参数查询
int TTSCTPTraderSpi::ReqQryRCAMSInterParameter(CThostFtdcQryRCAMSInterParameterField* pQryRCAMSInterParameter, int nRequestID)
{
    return this->pUserApi->ReqQryRCAMSInterParameter(pQryRCAMSInterParameter, nRequestID);
}

// RCAMS空头期权风险调整参数查询
int TTSCTPTraderSpi::ReqQryRCAMSShortOptAdjustParam(CThostFtdcQryRCAMSShortOptAdjustParamField* pQryRCAMSShortOptAdjustParam, int nRequestID)
{
    return this->pUserApi->ReqQryRCAMSShortOptAdjustParam(pQryRCAMSShortOptAdjustParam, nRequestID);
}

// RCAMS策略组合持仓查询
int TTSCTPTraderSpi::ReqQryRCAMSInvestorCombPosition(CThostFtdcQryRCAMSInvestorCombPositionField* pQryRCAMSInvestorCombPosition, int nRequestID)
{
    return this->pUserApi->ReqQryRCAMSInvestorCombPosition(pQryRCAMSInvestorCombPosition, nRequestID);
}

// 投资者品种RCAMS保证金查询
int TTSCTPTraderSpi::ReqQryInvestorProdRCAMSMargin(CThostFtdcQryInvestorProdRCAMSMarginField* pQryInvestorProdRCAMSMargin, int nRequestID)
{
    return this->pUserApi->ReqQryInvestorProdRCAMSMargin(pQryInvestorProdRCAMSMargin, nRequestID);
}

// RULE合约保证金参数查询
int TTSCTPTraderSpi::ReqQryRULEInstrParameter(CThostFtdcQryRULEInstrParameterField* pQryRULEInstrParameter, int nRequestID)
{
    return this->pUserApi->ReqQryRULEInstrParameter(pQryRULEInstrParameter, nRequestID);
}

// RULE品种内对锁仓折扣参数查询
int TTSCTPTraderSpi::ReqQryRULEIntraParameter(CThostFtdcQryRULEIntraParameterField* pQryRULEIntraParameter, int nRequestID)
{
    return this->pUserApi->ReqQryRULEIntraParameter(pQryRULEIntraParameter, nRequestID);
}

// RULE跨品种抵扣参数查询
int TTSCTPTraderSpi::ReqQryRULEInterParameter(CThostFtdcQryRULEInterParameterField* pQryRULEInterParameter, int nRequestID)
{
